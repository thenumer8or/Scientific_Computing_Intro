...
subplot (3,2,4)
quiver(X,Y,uplot',vplot');title(sprintf('Basic quiver plot of the velocity vectors a t= %g',t))
%
...
subplot (3,2,5)
quiver(X,Y,uplot',vplot',4);title(sprintf('Quiver plot of randomly chosen velocity vectors a t= %g',t))